...
logo ="""
 \033[1;96m ------------------------
 \033[1;32m < OFFICIAL CODER RIAZKHAN>
 \033[1;96m ------------------------
\033[1;96m
  =====================================================
|                  ASSALAMU ALAIKUM                     |
...
|         RIAZKHAN THE OFFICIAL PROGRAMMER [ H.O.P]     |
|               Whatsapp : RIAZKHAN               |
  ===================================================== 
...
\033[1;96m
  =====================================================
|                  ASSALAMU ALAIKUM                     |
|              Coded By : MR.Riazkhan                     |
|              Facebook : MR.Riazkhan                |
|      Editing My Script Will Not Make You  a Coder     | 
|        MR.Riazkhan THE OFFICIAL PROGRAMMER [ H.O.P]      |
...
jalan("\033[1;96m---> \033[1;32mWhatsapp No : 03188214452")
jalan("\033[1;96m---> \033[1;32mPakistani Hacker And Codder")
jalan("\033[1;96m---> \033[1;32mPROUD TO BE A MUSLIM PROUD TO BE PAKISTANI")

jalan('\033[1;96m---> \033[1;32mMr.riazkhan THE OFFICIAL PROGRAMMER \033[1;31m[ H.O.P ]')
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;32mACCESS GRANTED AS " + username #Dev:RIAZKHAN
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	print "\033[1;32m<-----\033[1;93mMR.riazkhan THE OFFICIAL PROGRAMMER㋡ H•O•P㋡\033[1;32m----->"
	print "\033[1;97m-------------------------------"
...
def pilih_super():
	...
	jalan(' \033[1;32m<-----\033[1;93mMR.Riazkhan THE OFFICIAL PROGRAMMER㋡ H•O•P㋡\033[1;32m----->')
	jalan(' \033[1;97m-----------------------------------')
	...
	p = ThreadPool(50)
	p.map(main, id)
	print "\033[1;32m<-----\033[1;93mMR.Riazhan THE OFFICIAL PROGRAMMER㋡ H•O•P㋡\033[1;32m----->"
	print "  \033[1;93m<-----Developed By MR.Riazkhan----->" #Dev:hamza
...
______________¶¶¶¶¶¶¶¶¶¶¶¶
 ...
 Having Problem Whatsapp Me :+923188214452"""
